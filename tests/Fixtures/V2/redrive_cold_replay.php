...
$database = json_decode((string) getenv('REDRIVE_DB_CONFIG'), true, flags: JSON_THROW_ON_ERROR);
...
$runId = (string) getenv('REDRIVE_RUN_ID');
...
if ($history === []) {
    throw new RuntimeException('No persisted history found for redrive replay.');
}

$result = WorkflowFiberRunner::forClass(
    TestRedriveWorkflow::class,
    'redrive-import-1',
    $runId,
    ['Taylor'],
    'avro',
