...
final class DefaultServiceBoundaryPolicyTest extends TestCase
{
    ...
    public function testAuthorizationDenialShortCircuitsRemainingGates(): void
    {
        $policy = new DefaultServiceBoundaryPolicy([
            'authorization' => [
                'required_roles' => ['service.call'],
            ],
            'rate_limit' => [
    ...
    public function testExplicitCallerNamespaceDeny(): void
    {
        $policy = new DefaultServiceBoundaryPolicy([
            'namespaces' => [
                'deny_callers' => ['untrusted'],
            ],
        ]);
    ...
    public function testCallerNotInAllowListIsBlocked(): void
    {
        $policy = new DefaultServiceBoundaryPolicy([
            'namespaces' => [
                'allow_callers' => ['analytics'],
            ],
        ]);
    ...
    public function testCrossNamespaceDefaultDenyBlocksUnequalNamespaces(): void
    {
        $policy = new DefaultServiceBoundaryPolicy([
            'namespaces' => [
        ...
        $decision = $policy->evaluate($this->request(callerNamespace: 'finance', targetNamespace: 'billing'));

        $this->assertSame(ServiceCallOutcome::RejectedForbidden, $decision->outcome);
        $this->assertSame('cross_namespace_blocked', $decision->reason);
    }

    public function testCircuitOpenBlocksTargetWithRetryAdvice(): void
    {
    ...
    public function testConcurrencyLimitBlocksExcessSyncCalls(): void
    {
        $policy = new DefaultServiceBoundaryPolicy([
            'concurrency' => [
                'max_in_flight' => 2,
    ...
    public function testConcurrencySyncOnlyDoesNotCountAsyncCalls(): void
    {
        $policy = new DefaultServiceBoundaryPolicy([
            'concurrency' => [
                'max_in_flight' => 1,
    ...
    public function testReleaseClearsInFlightCounter(): void
    {
        $policy = new DefaultServiceBoundaryPolicy([
            'concurrency' => [
                'max_in_flight' => 1,
    ...
    public function testRateLimitBlocksAfterWindowCapacityReached(): void
    {
        $policy = new DefaultServiceBoundaryPolicy([
            'rate_limit' => [
    ...
    public function testAxisAllowListsPermitWhenEveryAxisAllowsCaller(): void
    {
        $policy = new DefaultServiceBoundaryPolicy();
    ...
    public function testEndpointServiceAndOperationPolicyRecordDeniedAxis(): void
    {
        $policy = new DefaultServiceBoundaryPolicy();
    ...
    public function testOutcomeCategoriesMapConsistentlyForAuditConsumers(): void
    {
